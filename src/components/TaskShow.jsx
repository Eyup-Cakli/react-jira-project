            ...
            <TaskCreate task={task} taskFormUpdate={true} onUpdate={handleSubmit} />
                ...
                <div>
                    ...
                    <div className="task-show-buttons">
                        <button className="task-show-buttons-delete" onClick={handleDeleteClick}>Sil</button>
                        <button className="task-show-buttons-update" onClick={handleEditClick}>Güncelle</button>
                    </div>
                </div>
            )}
        </div>
